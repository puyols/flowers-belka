...
MegaFilter.prototype = {
	...
	*/
	...
	_initCountInfo: function() {
		...
		self._ajaxGetInfo(['categories:tree','categories:cat_checkbox','vehicles','price']);
	...
	_initEvents: function() {
		...
		self._box.find('input[type=checkbox],input[type=radio],select:not([data-type="category-related"])').change(function(){
			...
			if( type && type.split('-')[0] == 'vehicle' && type.split('-')[1] != 'years' && self._options['refreshResults'] == 'using_button' ) {
