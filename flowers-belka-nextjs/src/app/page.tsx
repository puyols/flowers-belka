...
import { completeProducts, getCompleteHitProducts, getCompleteProductsByCategory } from '../data/products-complete';
import { getLatestNews } from '../data/news';
import { getHomeSEO, getOrganizationData } from '../utils/seo';

export default function HomePage() {
  const hitProducts = getCompleteHitProducts().slice(0, 8);
  const popularProducts = completeProducts
    .sort((a, b) => {
