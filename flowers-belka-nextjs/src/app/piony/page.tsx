...
export default function PionyPage() {
  ...
  const seoData = getCategorySEO('piony');
  const breadcrumbs = generateBreadcrumbs('/piony');
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-4" style={{color: 'rgb(212, 20, 90)'}}>
              Пионы с доставкой в Путилково
            </h1>
            <p className="text-gray-600 max-w-3xl">
              Роскошные пионы - символ богатства, процветания и счастья. Пышные многослойные лепестки 
              создают неповторимую атмосферу роскоши. Доступны только в сезон (май-июль), что делает их особенно ценными.
            </p>
          </div>
