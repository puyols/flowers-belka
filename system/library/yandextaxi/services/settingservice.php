...
class SettingService
{
    ...
    public function getEditable(): array {
        return [
            ...
            self::BASE . '_supplier_inn' => $this->getOne(self::BASE . '_supplier_inn'),
            self::BASE . '_vat_code' => $this->getOne(self::BASE . '_vat_code'),
            ...
            self::BASE . '_country' => $this->getOne(self::BASE . '_country'),
